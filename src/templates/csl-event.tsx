...
import { cleanLocation, formatDateWithTimeCSL, getYearFromDate } from '../utils';
          ...
          <header id="event-information" className={`event-header ${isFormSent ? 'form-sent' : ''}`}>
            ...
            <div className="event-metadata">
              <div className="date-container">
                <span className="date">
                  <span>
                    {formatDateWithTimeCSL(raw_start, start_in_zone, raw_end, end_in_zone)}
                    {isDisabled ? ` ${getYearFromDate(raw_start)}` : ''}
                  </span>
                </span>
                {collection && (
