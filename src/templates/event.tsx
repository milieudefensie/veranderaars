...
https://veranderaars.milieudefensie.nl/agenda/${slug}#travel-together
`,
                  extraContent: {
                    text: '<p>Vergeet niet om je aan te melden voor dit evenement <br> zodat je op de hoogte blijft van belangrijke updates:</p>',
                    button: '👉 Meld je aan voor evenement',
